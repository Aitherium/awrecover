"""Stack-aware `doctor` for awrecover.
...
interesting failures live BETWEEN them. "awrecover is installed" is not the useful
fact -- "awrecover is installed and the thing it pairs with is not" is. This reports
...
SELF = 'awrecover'
FAMILY = ['awask', 'awask', 'awbac', 'awbrowse', 'awdit', 'awevolve', 'awevolve', 'awfind', 'awgit', 'awgraph', 'awiam', 'awkno', 'awm', 'awmail', 'awnboard', 'awnest', 'awnet', 'awnode', 'awpredict', 'awprism', 'awreason', 'awrecurse', 'awrelay', 'awrepl', 'awresearch', 'awrun', 'awseal', 'awshare', 'awtunnel']
PAIRS_WITH = ['awshare']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awrecover needs at runtime, and a
